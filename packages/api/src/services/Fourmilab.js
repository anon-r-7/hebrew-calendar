// @RyanOstrom
// Added document and `from_` methods
let document = {
    gregorian: {
        year: { value: null },
...
function from_gregorian(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_julian(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_modified_julian(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_julian_calendar(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_gregorian_serial(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_hebrew(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_islamic(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_persiana(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_persian(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_mayan(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_bahai(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_indian(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_french(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_iso_week(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_iso_day(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_unix_time(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_excel_serial_1900(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
function from_excel_serial_1904(partial_document) {
  document = {
    ...document,
    ...partial_document
  }
...
module.exports = {
    from_gregorian,
    from_julian,
    from_modified_julian,
    from_julian_calendar,
    from_gregorian_serial,
    from_hebrew,
    from_islamic,
    from_persiana,
    from_persian,
    ...
    from_iso_day,
    from_unix_time,
    from_excel_serial_1900,
    from_excel_serial_1904
}
